...
exports.ProjectHealthGenerator = void 0;
class ProjectHealthGenerator {
    ...
    async generate(params) {
        ...
        const rows = projects.map((p) => {
            ...
            const milestonesDone = new Set(p.submissions.filter((s) => !!s.milestoneId).map((s) => s.milestoneId)).size;
...
exports.ProjectHealthGenerator = ProjectHealthGenerator;
